...
5. [OOP & SOLID (Pragmatically)](#oop--solid-pragmatically)
6. [Functional Programming (Balanced)](#functional-programming-balanced)
7. [Kotlin Idioms](#kotlin-idioms)
